-- CreateEnum
CREATE TYPE "BookStatus" AS ENUM ('READING', 'TO_READ', 'INTERESTED');
...
-- CreateIndex
CREATE INDEX "Flowchart_isbn_idx" ON "Flowchart"("isbn");
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES "BookThread"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
