...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gradient-to-b from-gray-900 to-gray-800">
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <Link href="/api/auth/signin">
          <Button className="mt-8 px-8 py-3 text-lg bg-blue-600 hover:bg-blue-700">
            Get Started
          </Button>
        </Link>
      </main>
...
function FeatureCard({
  ...
  return (
    <div className="p-6 mt-6 text-left border border-gray-700 rounded-xl hover:border-blue-500 transition-colors duration-300 max-w-xs">
      {icon}
